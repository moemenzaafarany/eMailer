...
import { MultiProviders, eColor, eList } from "react-e-utils";
import { UserModel } from "./models/UserModel";
import { Box, Button, createTheme, responsiveFontSizes } from "@mui/material";
// package
...
const App = () => {
  return (
    <MultiProviders
      ...
      render={({ dir }) => {
        return (
          <MuiApp dir={dir} theme={CreateMuiTheme()}>
